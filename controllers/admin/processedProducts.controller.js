...
const listCategoryProductKeys = async (clientName) => {
  ...
  const normalizedClient = sanitizePathSegment(clientName || "test_sunglasses_new");
...
exports.getProcessedCategorySummary = async (req, res) => {
  try {
    const clientName = req.query.clientName || "test_sunglasses_new";
...
exports.getProcessedCategoryDetails = async (req, res) => {
  try {
    const clientName = req.body?.clientName || "test_sunglasses_new";
